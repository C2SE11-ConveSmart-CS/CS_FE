...
import logo_dtu from "../../assets/logoDTU.png";
...
function ChatBot(props) {
  ...
  let [sourceData, SetSourceData] = useState("dtu");
  ...
  const [dataChat, SetDataChat] = useState([
    [
      "start",
      [
        "Xin chào! Đây là DTU Chatbot, trợ lý đắc lực dành cho bạn! Bạn muốn tìm kiếm thông tin về những gì? Đừng quên chọn nguồn tham khảo phù hợp để mình có thể giúp bạn tìm kiếm thông tin chính xác nhất nha. 😄",
        null,
      ],
    ],
  ]);
  ...
  async function SendMessageChat() {
    if (promptInput !== "" && isLoading === false) {
      ...
      fetch("https://goose-smooth-bulldog.ngrok-free.app/rag/" + sourceData + "?q=" + promptInput,
    ...
    SetReference({
      title:
        sourceType == "wiki"
          ...
          : sources.metadata.page==undefined? "Sổ tay sinh viên 2024" : "Trang " + sources.metadata.page + " (sổ tay SV)",
      source: sourceType == "wiki" ? "Wikipedia" : "Đại học Duy Tân Đà Nẵng",
      url:
        sourceType == "wiki"
          ? sources.metadata.source
          : "https://https://duytan.edu.vn",
      text:
              ...
              <div className="chat chat-start drop-shadow-md" key={i}>
                <div className="chat-image avatar">
                  <div className="w-10 rounded-full border-2 border-blue-500">
                    <img className="scale-150" src={logo_dtu} />
                  </div>
                </div>
                ...
                <div className="chat-bubble shadow-xl chat-bubble-primary bg-gradient-to-r from-purple-500 to-blue-500 text-white">
                  ...
                  <>
                    ...
                    <p className="font-light text-xs text-cyan-50">
                      Tham khảo:{" "}
                      {dataMessages[1][1] == "wiki" ? "Wikipedia" : "DTU"}
                    </p>
                  </>
                </div>
              </div>
